...
# UI -> bridge
ADMIN_CONTROL_TOPIC = "/ui/admin_control"          # std_msgs/String: PAUSE, RESUME, CANCEL, ESTOP, ESTOP_RELEASE_HOME, RECOVER
...
ESTOP_TOPIC = "/ui/emergency_stop"                # std_msgs/Bool: True stop, False release+home
...
class BartenderAdminControlBridge(Node):
    ...
    def _admin_command_cb(self, msg: String):
        ...
        if command == "ESTOP_RELEASE_HOME":
            ...
            out.data = False
            self.estop_pub.publish(out)
            self._add_log("OK", "emergency stop release + home published: False")
            return
